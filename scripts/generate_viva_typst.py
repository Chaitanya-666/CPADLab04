...
viva_content = """#import "GEMINI_viva_template.typ": *
...
Path("Lab04/typst/CPAD_VivaPrep_Lab04_ChaitanyaShinde231070066.typ").write_text(viva_content)
print("CPAD_VivaPrep_Lab04_ChaitanyaShinde231070066.typ generated successfully.")
